...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TravelogueResources@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TravelogueResources API";

        private String description = "TravelogueResources API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TravelogueResources";
