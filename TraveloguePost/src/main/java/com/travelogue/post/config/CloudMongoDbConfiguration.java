package com.travelogue.post.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.travelogue.post.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.travelogue.post.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.travelogue.post.config.dbmigrations");
