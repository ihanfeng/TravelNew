...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TraveloguePost@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TraveloguePost API";

        private String description = "TraveloguePost API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TraveloguePost";
