package com.travelogue.registry;
...
import com.travelogue.registry.config.Constants;

@SpringBootApplication
@EnableEurekaServer
@EnableConfigServer
public class TravelogueRegistry {

    private static final Logger log = LoggerFactory.getLogger(TravelogueRegistry.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TravelogueRegistry.class);
