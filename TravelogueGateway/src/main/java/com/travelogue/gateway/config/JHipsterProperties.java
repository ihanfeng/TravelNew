...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TravelogueGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TravelogueGateway API";

        private String description = "TravelogueGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TravelogueGateway";
