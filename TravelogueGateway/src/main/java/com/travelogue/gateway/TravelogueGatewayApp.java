package com.travelogue.gateway;

import com.travelogue.gateway.config.Constants;
import com.travelogue.gateway.config.JHipsterProperties;
...
@EnableEurekaClient
@EnableZuulProxy
public class TravelogueGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(TravelogueGatewayApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes TravelogueGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TravelogueGatewayApp.class);
