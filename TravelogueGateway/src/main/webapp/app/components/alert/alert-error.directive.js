(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('travelogueGatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-travelogueGatewayApp-error');
                var entityKey = httpResponse.headers('X-travelogueGatewayApp-params');
                if (errorHeader) {
